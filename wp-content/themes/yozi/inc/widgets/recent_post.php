...
class Yozi_Recent_Post extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'yozi'),
            array( 'description' => esc_html__( 'Show list of recent post', 'yozi' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'yozi' ); ?></label>
...
register_widget( 'Yozi_Recent_Post' );