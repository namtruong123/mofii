...
?>
<div class="product-block product-block-list list-v1" data-product-id="<?php echo esc_attr($product_id); ?>">
	        	...
	        	<div class="cate-wrapper clearfix">
	        		...
	        		<div class="pull-right">
		        		<?php
				            ...
				            } elseif ( yozi_is_woosw_activated() && get_option('woosw_button_position_archive') == "0" ) {
		...
		<div class="caption-buttons">
	        ...
	        <?php } elseif( yozi_is_woosc_activated() && get_option('woosc_button_archive') == "0" ) {?>
