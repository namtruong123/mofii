...
$layout = !empty($layout) ? $layout : yozi_get_config('product_single_version', 'v1');
$thumbs_pos = !empty($thumbs_pos) ? $thumbs_pos : yozi_get_config('product_thumbs_position', 'thumbnails-left');
$number_product_thumbs = !empty($number_product_thumbs) ? $number_product_thumbs : yozi_get_config('number_product_thumbs', 4);
...
<?php } elseif ( $layout == 'preview' ) {
?>
	<div class="apus-woocommerce-product-gallery-wrapper preview-gallery">
		<?php
	    $onsale_price = yozi_onsale_price_show();
	    if ($onsale_price && $product->is_type( 'simple' )) {?>
	            <div class="downsale">-<?php echo wc_price($onsale_price); ?></div>
		...
		<div class="slick-carousel apus-woocommerce-product-gallery" data-carousel="slick-gallery" data-items="1" data-smallmedium="1" data-extrasmall="1" data-pagination="true" data-nav="false">
			<?php
			$attributes = array(
				'title'                   => get_post_field( 'post_title', $post_thumbnail_id ),
				'data-caption'            => get_post_field( 'post_excerpt', $post_thumbnail_id ),
