	...
	public function add_options() {
		...
		Options::add_field(
			array(
				...
				'notices'     => array(
					'switcher' => esc_html__( 'To ensure that website visitors can see the coupon in the email, it needs to be manually inserted as a shortcode {coupon_code} in WooCommerce -> Settings -> Emails -> Reminder: Incomplete Purchase Notification', 'woodmart' ),
				),
