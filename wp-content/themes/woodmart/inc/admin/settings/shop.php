...
Options::add_field(
	array(
		...
		'name'     => esc_html__( 'Show SKU on order details', 'woodmart' ),
		'group'    => esc_html__( 'SKU', 'woodmart' ),
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'Hide a higher price for variable products. This option will work only if a plugin or custom code does not modify the price structure.', 'woodmart' ),
...
Options::add_field(
	array(
		'id'       => 'cart_totals_layout',
		'name'     => esc_html__( 'Cart totals layout', 'woodmart' ),
		'type'     => 'buttons',
